<template>
  <div :class='s.wrap'>
    ...
    <div :class='s.item'>
      ...
      街道信息
      <!-- 街道名称 -->
      <el-select :class='s.elInput' v-model="searchStreetID" placeholder="请选择街道信息">
        <el-option
    ...
    <div :class='s.item'>
      ...
      社区名称
      <!-- 社区名称 -->
      <el-select :class='s.elInput' v-model="country.CommunityID" placeholder="请选择社区名称">
        <el-option
    ...
    <div :class='s.item'>
      ...
      小区名称
      <!-- 小区名称 -->
      <el-input :class='s.elInput' v-model="country.Name" placeholder="请输入小区名称" @focus='onFocus'></el-input>
    </div>
    <div :class='s.item'>
      <div :class='s.red'>*</div>
      地理位置
